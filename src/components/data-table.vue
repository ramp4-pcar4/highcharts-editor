            ...
            <table class="table-auto border-collapse border-dotted border border-black w-full mt-8">
                <thead>
                    <tr class="bg-gray-200">
                        ...
                        <th
                            class="border cursor-pointer border-dotted border-gray-400 p-2 text-center text-gray-400 max-w-[25px]"
                            @click="addNewCol"
                        >
                ...
                <tbody>
                    ...
                    <tr :class="gridData.length % 2 === 0 ? 'bg-gray-50' : ''">
                        <td
                            class="border cursor-pointer border-dotted border-gray-400 p-2 text-center font-bold text-gray-400"
                            @click="addNewRow"
                        >
